...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-plume-lang-parser-detail.ps1

julia --project=. tests/domain_review.jl

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-plume-lang-parser-properties.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-plume-lang-parser-golden.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-plume_lang_parser_loom-casebook.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
