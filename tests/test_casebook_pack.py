"""Regression checks for the plume-lang-parser-loom casebook."""
...
from casebook.harness import assert_expected, plume_lang_parser_loom_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(plume_lang_parser_loom_summary(), assert_expected())
